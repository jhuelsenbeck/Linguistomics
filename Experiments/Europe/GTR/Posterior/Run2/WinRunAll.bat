"Z:/Documents/GitHub/Linguistomics/Indelly/x64/release/tonguetwister.exe" -d "config.json" -o "Z:/Documents/GitHub/Linguistomics/Experiments/Europe/GTR/Posterior/Run2/Execute/out" 
pause
